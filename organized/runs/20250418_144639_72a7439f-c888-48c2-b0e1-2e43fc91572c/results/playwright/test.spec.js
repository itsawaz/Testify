...
test('go to i am game at http://103.140.219.4:5173/auth/login -> login id: madhukar.cool09@gmail.com password: Test@123 ->  make a dummy post -> then go to user profile -> edit the username name to madukar  ->find the  logout option -> logout', async ({ page }) => {
