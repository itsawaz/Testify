...
Scenario: Input the username 'standard_user' and password 'secret_sauce' into their respective fields and click the 'Login' button.
  When I enter "standard_user" into field with index 1
  When I enter "secret_sauce" into field with index 2

Scenario: Click the 'Login' button to attempt logging into the system.
  When I click on the input with index 3

Scenario: Declare ultimate task completion.
