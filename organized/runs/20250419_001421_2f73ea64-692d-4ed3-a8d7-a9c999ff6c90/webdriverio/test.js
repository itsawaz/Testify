// WebdriverIO test script for: go to http://sahanalogistics.com/tms/Login.aspx -> id : admin and password : admin ->  go to tms -> logout
// Generated from agent execution history

describe('go to http://sahanalogistics.com/tms/Login.aspx -> id : admin and password : admin ->  go to tms -> logout', () => {{
    it('should automate the task', async function() {{
        // Set a reasonable timeout for the test
        this.timeout(30000);
        
        // Step 1: Navigate to URL
        await browser.url('http://sahanalogistics.com/tms/Login.aspx');
